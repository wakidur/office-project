'use strict';
var starterApp = angular.module('cricketInfo', ['ngMaterial','ngAnimate','ui.router']);

// configure our routes
starterApp.config(function($stateProvider, $urlRouterProvider, $locationProvider) {
...
starterApp.service('StatisticService', function($filter) {
